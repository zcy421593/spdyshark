 ...
 */
static int dissect_spdy_frame(tvbuff_t *tvb, int offset, packet_info *pinfo,
  ...
  switch (frame_type) {
    ...
    case SPDY_HEADERS:
      ...
      if (tree) {
        ...
        hf = frame_type == SPDY_SYN_STREAM ?
            hf_spdy_syn_stream : hf_spdy_syn_reply;
      ...
      if (frame_type == SPDY_SYN_STREAM) {
        ...
        /* The next two bytes have no meaning in SYN_REPLY and HEADERS */
        offset += 2;
      }
